...
public class WebClientIT {
    ...
    @Test
    public void testDeleteBeer() throws InterruptedException {
    ...
    @Test
    public void testListBeers() throws InterruptedException {
        CountDownLatch countDownLatch = new CountDownLatch(1);
    ...
    @Test
    public void testListBeersPageSize5() throws InterruptedException {
        CountDownLatch countDownLatch = new CountDownLatch(1);
    ...
    @Test
    public void testListBeersByName() throws InterruptedException {
        CountDownLatch countDownLatch = new CountDownLatch(1);
